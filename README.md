...
> **참고:** 이미지는 프로젝트 환경에 맞게 `assets/` 디렉터리에 저장한 후 적용된 예시입니다.
...
### 2. AI 감정평가서 리포트 (PDF)
![Report Screen](assets/report_screen.png)
...
- **Libraries**: Lucide React, Recharts, Motion, Axios

### Backend
- **Framework**: FastAPI (Python 3.10)
- **AI / Vision**: YOLOv8 (Ultralytics), OpenCV, Pillow
- **Data Processing**: Pandas, Numpy
- **Template & PDF**: Jinja2, Playwright
- **LLM Integration**: Google GenAI, Ollama
