...
> **참고:** 아래 이미지는 임시 플레이스홀더입니다. 실제 스크린샷 깃허브 URL로 교체해 주세요.

### 1. 메인 대시보드 및 AI 결함 탐지 분석
![Main Screen](https://via.placeholder.com/800x400.png?text=Main+Dashboard+Screenshot)
- 건축물대장 조회 및 YOLOv8 Vision AI를 활용한 결함(Crack) 탐지

### 2. AI 감정평가서 리포트 (PDF)
![Report Screen](https://via.placeholder.com/800x400.png?text=Appraisal+Report+PDF+Screenshot)
